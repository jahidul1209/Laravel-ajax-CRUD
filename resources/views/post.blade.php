...
<div class="container">
  ...
  <a href="{{URL :: to ('email')}}" class="btn btn-sm btn-danger text-white" style="float: right;">Email</a>
...
@include('form');
    ...
    var table1 = $('#post-table').DataTable({
       ...
       function showData(id) {
          $.ajax({
            ...
            success: function(data) {
              ...
              $('#tagid').text(data.tag);
               $('#descriptionid').text(data.description);
            },
            error : function() {
                alert("Ghorar DIm");
            }
      ...
      function deleteData(id){
          ...
          swal({
            title: "Are you sure?",
            text: "Once deleted, you will not be able to recover this deleted file!",
            icon: "warning",
            buttons: true,
            dangerMode: true,
          })
